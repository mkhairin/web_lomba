                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control select" id="id_pembimbing" name="id_pembimbing" style="width: 100%;">
                                                ...
                                                <?php foreach ($dataPembimbing as $pembimbing) : ?>
                                                    <option value="<?= $pembimbing->id_pembimbing ?>"><?= $pembimbing->nama_pembimbing ?></option>
                                                <?php endforeach; ?>
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select" id="id_tim_lomba" name="id_tim_lomba" style="width: 100%;">
                                                    ...
                                                    <?php foreach ($dataTimLomba as $timLomba) : ?>
                                                        <option value="<?= $timLomba->id_tim_lomba ?>" <?= ($timLomba->id_tim_lomba == $timlolos->id_tim_lomba) ? 'selected' : '' ?>>
                                                            <?= $timLomba->nama_tim ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select" id="id_lomba" name="id_lomba" style="width: 100%;">
                                                    ...
                                                    <?php foreach ($dataLomba as $lomba) : ?>
                                                        <option value="<?= $lomba->id_lomba ?>" <?= ($lomba->id_lomba == $timlolos->id_lomba) ? 'selected' : '' ?>>
                                                            <?= $lomba->nama ?>
                                                        </option>
                                                    <?php endforeach; ?>
                                                </select>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select" id="id_sekolah" name="id_sekolah" style="width: 100%;">
                                                    ...
                                                    <?php foreach ($dataSekolah as $sekolah) : ?>
                                                        <option value="<?= $sekolah->id_sekolah ?>" <?= ($sekolah->id_sekolah == $timlolos->id_sekolah) ? 'selected' : '' ?>>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select" id="id_pembimbing" name="id_pembimbing" style="width: 100%;">
                                                    ...
                                                    <?php foreach ($dataPembimbing as $pembimbing) : ?>
                                                        <option value="<?= $pembimbing->id_pembimbing ?>" <?= ($pembimbing->id_pembimbing == $timlolos->id_pembimbing) ? 'selected' : '' ?>>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="nilai">Nilai Skor</label>
                                                <input type="number" class="form-control" id="nilai" name="nilai" value="<?= $timlolos->nilai ?>" placeholder="Masukkan Nilai Akhir">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control select" id="status" name="status" style="width: 100%;">
                                                    ...
                                                    <option value="Lolos" <?= ($timlolos->status == 'Lolos') ? 'selected' : '' ?>>Lolos</option>
                                                    <option value="Tidak Lolos" <?= ($timlolos->status == 'Tidak Lolos') ? 'selected' : '' ?>>Tidak Lolos</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <?php foreach ($dataTimLolos as $timLolos) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-danger btn-sm" href="/daftar-lolos/delete/<?= $timLolos->id_tim_lolos ?>" role="button">Delete</a>
                                </td>
                            </tr>
                        <?php endforeach ?>
                    </tbody>
