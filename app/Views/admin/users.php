        ...
        <!-- Modal Delete -->
        <?php foreach ($dataUsers as $user) : ?>
            <form action="/user/delete/<?= $user->id_user ?>">
                <?php csrf_field() ?>
                <div class="modal fade" id="modal-delete<?= $user->id_user ?>">
        ...
        <div class="az-content-body pd-lg-l-40 d-flex flex-column">
            ...
            <p class="mg-b-20">Daftar akun user atau juri yang terdaftar dalam sistem, termasuk nama, peran, dan status akun.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <button type="button" class="btn btn-outline-primary btn-sm" data-toggle="modal"
                                        data-target="#modal-delete<?= $user->id_user ?>">Delete</button>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
