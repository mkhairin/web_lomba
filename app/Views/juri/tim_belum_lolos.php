          ...
          <div class="az-content-body pd-lg-l-40 d-flex flex-column">
              ...
              <h2 class="az-content-title">Daftar Tim Tidak Lolos</h2>

              <div class="az-content-label mg-b-5">Informasi Tim Tidak Lolos</div>
              <p class="mg-b-20">Daftar tim yang tidak lolos seleksi dan tidak melanjutkan ke tahap berikutnya dalam kompetisi.</p>
              ...
              <div class="table-responsive">
                  <table id="example" class="table table-striped">
                      ...
                      <tbody>
                          <?php $i = 1 ?>
                          <?php foreach ($dataTimBelumLolos as $data) : ?>
                              <tr>
                                  <td><?= $i++ ?></td>
                                  <td><?= esc($data->tim) ?></td>
